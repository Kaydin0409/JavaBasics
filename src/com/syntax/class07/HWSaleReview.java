...
public class HWSaleReview {
	...
	public static void main(String[] args) {
		...
		double price;
		double discount = 0.00, salePrice = 0.00;
		...
		if (sale.equalsIgnoreCase("yes")) {
			...
			salePrice = price - ((price*discount)/100); //you can put this outside the if and else if and put at end since it is the same for EVERY condition
